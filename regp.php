...
<head>
	...
	<link rel="stylesheet" type="text/css" href="\lib\css\Rg2.css">
...
$nameErr = $emailErr = $pswdErr = $cpswdErr = "";
$name = $email = $pswd = $cpswd = $mobile = $address = $city = "";
  ...
  if (empty($_POST["confirm"])) {
    $cpswdErr = "Password is required";
  	...
  	if ($_POST["password"]===$_POST["confirm"]) {
  		$cpswd = test_input($_POST["confirm"]);
  	}
    else
    {
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="\img\lg1.jpg"></a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active" id="rgbtn"><a href="#" id="btn_rgst">Register <span class="sr-only">(current)</span></a></li>
        <li id="lgbtn"><a href="#" id="btn_lgn">Login</a></li>
        <li class="dropdown">
...
<div class="container" id="cont">
		...
		<h1 id="h" align="center">Registration</h1>
				...
				<fieldset id="account">
					<legend>Your Personal Details</legend>
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="firstname" value="<?php echo $name;?>" placeholder="Full Name" id="input-name" class="form-control"><span class="error">* <?php echo $nameErr;?></span>
							</div>
						</div>
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="tel" name="mobile" value="<?php echo $mobile;?>" placeholder="Mobile" id="input-mobile" class="form-control">
							</div>
						</div>
					</fieldset>
					<fieldset id="address">
						...
						<div class="form-group required">
							...
							<div class="col-sm-10">
								<input type="text" name="address_1" value="<?php echo $address;?>" placeholder="Address" id="input-address-1" class="form-control">
							</div>
						</div>
						<div class="form-group required">
